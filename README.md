...
<table width="100%" cellspacing="0" cellpadding="4" border="0">
  <tr>
    ...
    <td width="200">
          <p> On this screen, you can create a new connection to a PLC or edit an existing connection.
              It is possible to delete the connection or mark it as the default connection using 3d-touch. Default connection mark with symbol "Star".
